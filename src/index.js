...
export class TextHover extends React.Component{
...
console.log("textehover")
 ...
 export class TextEffect extends React.Component {
    ...
    render() {
        ...
        switch (this.props.name) {
            ...
            default:
        return (this.state.text.map((el,i) => <div key={i} className={this.state.className}>{el}</div>));
        }
